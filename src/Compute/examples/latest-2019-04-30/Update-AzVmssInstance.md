...
### Example 67: Create or update a gallery Image Version. (autogenerated)
```powershell
...
### Example 71: Update a VM scale set. (autogenerated)
```powershell
...
### Example 72: Upgrades one or more virtual machines to the latest SKU set in the VM scale set model. (autogenerated)
```powershell
